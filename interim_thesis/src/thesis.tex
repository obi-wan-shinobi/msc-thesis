...
% thesis committee:
\chair{Dr. D. M. J. Tax, Faculty EEMCS, TU Delft}
\supervisor{Dr. F. Bartolucci, Faculty EEMCS, TU Delft}
\dailysupervisor{Dr. A. Heinlein, Faculty EEMCS, TU Delft}
...
\makeformaltitlepages{\input{frontmatter/abstract}}         % for formal title pages with all info
